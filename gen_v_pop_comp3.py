...
np.savetxt('/Users/samcampion/Documents/University/Uni Y3/Project/Python Stuff/gen_energy_min_3.txt',energy_min_list,fmt='%s')
np.savetxt('/Users/samcampion/Documents/University/Uni Y3/Project/Python Stuff/gen_energy_avg_3.txt',energy_avg_list,fmt='%s')
